...
fidas_Data['TimeDateSince'] = fidas_Data.index-datetime.datetime(1970,1,1,0,0,00)
fidas_Data['TimeSecondsSince'] = fidas_Data['TimeDateSince'].dt.total_seconds()
fidas_Data['day_year'] = pd.DatetimeIndex(fidas_Data['TimeDateSince']).dayofyear
fidas_Data['year'] = pd.DatetimeIndex(fidas_Data['TimeDateSince']).year
fidas_Data['month'] = pd.DatetimeIndex(fidas_Data['TimeDateSince']).month
fidas_Data['day'] = pd.DatetimeIndex(fidas_Data['TimeDateSince']).day
fidas_Data['hour'] = pd.DatetimeIndex(fidas_Data['TimeDateSince']).hour
fidas_Data['minute'] = pd.DatetimeIndex(fidas_Data['TimeDateSince']).minute
fidas_Data['second'] = pd.DatetimeIndex(fidas_Data['TimeDateSince']).second
