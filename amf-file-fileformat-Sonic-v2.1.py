...
dataset_out = nc.Dataset(direct + 'sonic-windmaster_maqs_' + str(date_file_label) + '_mean-winds_'  + str(datatype) + '_' + str(version_number) + '.nc', 'w', format='NETCDF4_CLASSIC')

dataset_out.Conventions = 'CF-1.6, NCAS-AMF-1.1'
dataset_out.source = 'sonic-windmaster_maqs'
