...
dataset_out = nc.Dataset(direct + 'lgr-multicarbon_maqs_' + str(date_file_label) + '_CH4-CO2-CO-H2O_concentration' + str(status) + str(version_number) + '.nc', 'w', format='NETCDF4_CLASSIC')
